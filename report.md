...
- **Academic explanations** — 3Blue1Brown, Two Minute Papers, and Yannic Kilcher, providing visualizations of principles and deep dives into research papers.
- **Industry leaders** — OpenAI, Google DeepMind, and Andrej Karpathy, contributing official releases and hands-on practice insights.
- **AI news channels** — AI Explained and Lex Fridman, offering industry analyses and weekly updates.
- **Educational platforms** — DeepLearning.AI, Andrew Ng, and Machine Learning Street Talk, focusing on course promotion and academic interviews.
...
**Categorization accuracy.** Current classification relies on regular expression keyword matching, which occasionally places videos into broad AI/ML categories. Introducing LLM-based content classification could improve precision.
